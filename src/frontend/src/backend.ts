...
export class Backend implements backendInterface {
    ...
    async addMediaItem(arg0: string, arg1: string, arg2: MediaType, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMediaItem(arg0, arg1, to_candid_MediaType_n8(this._uploadFile, this._downloadFile, arg2), await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStudioInfo(): Promise<StudioInfo | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudioInfo();
    ...
    async listMediaItems(): Promise<Array<MediaItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.listMediaItems();
    ...
    async submitBooking(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateStudioInfo(arg0: StudioInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStudioInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_MediaItem_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaItem): Promise<MediaItem> {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StudioInfo]): StudioInfo | null {
    return value.length === 0 ? null : value[0];
}
...
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MediaItem>): Promise<Array<MediaItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MediaItem_n18(_uploadFile, _downloadFile, x)));
}
